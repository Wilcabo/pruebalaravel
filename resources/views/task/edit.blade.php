...
<div class="mcw" >
  ...
  <div class="cv">
    ...
    <form action="{{ route('actualizar', $task->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="due_date" name="due_date" value="{{ old('due_date', $task->due_date)->format('Y/m/d') }}">
    </div>
